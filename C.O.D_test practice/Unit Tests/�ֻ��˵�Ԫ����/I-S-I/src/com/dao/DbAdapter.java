...
public class DbAdapter {
	 ...
	 * 表及属性
	 */
	private static final String DATABASE_CREATE = "create table remindnotes (_id integer primary key autoincrement, "
	...
	private String flagUsedAsTesting;
	...
	public Cursor fetchNote(long rowId) throws SQLException {
		...
		Cursor mCursor = mDb.query(true, DATABASE_TABLE, new String[] {
				KEY_ROWID, KEY_TITLE, KEY_BODY, KEY_DATE }, KEY_ROWID + "="
